...
namespace Aray
{
    public partial class UpperGround : Form
    {
        private Button selectedSlotButton = null;
        private Label selectedSlotLabel = null;
        private Dictionary<string, (Button btn, Label lbl)> slotMap;
        ...
        public UpperGround()
        {
            ...
            slotMap = new Dictionary<string, (Button, Label)>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "Upper 8", (btnU8, lblU8) },
                { "Upper 9", (btnU9, lblU9) },
                { "Upper 10", (btnU10, lblU10) },
                { "Upper 11", (btnU11, lblU11) },
                { "Upper 12", (btnU12, lblU12) },
                { "Upper 13", (btnU13, lblU13) },
                { "Upper 14", (btnU14, lblU14) },
                { "Upper 15", (btnU15, lblU15) }
             };
        ...
        public void SetBaseAreaForm(BaseArea baForm)
        {
            baseAreaForm = baForm;
        }

        private void UpperGround_Load(object sender, EventArgs e)
        {
        ...
        public void RefreshSlots()
        {
            ...
            if (baseAreaForm != null)
                lblBAA.Text = $"Base Area Occupied: {GetBaseAreaOccupied()}/{baseAreaForm.GetSlotCount()}";


            UpdateUpperGroundAvailability();
        }


        private void UpdateUpperGroundAvailability()
        {
            int occupiedSlots = 0;
            ...
            lblUGA.Text = $"Upper Ground Availability: {occupiedSlots}/{slotMap.Count}";
        }
        ...
        public int GetBaseAreaOccupied()
        {
            if (baseAreaForm == null) return 0;
            return baseAreaForm.GetOccupiedSlots();
        }

        private void lblUGA_Click(object sender, EventArgs e)
        {
        ...
        {
            // Ask the user to input the slot manually
            string inputSlot = Microsoft.VisualBasic.Interaction.InputBox(
                "Enter the slot number (Example: UG1, UG2, ...):",
                "Slot Entry",
                ""
            );
            ...
            // Update availability
            UpdateUpperGroundAvailability(); // your method to refresh UG labels
        ...
        private void btnBA_Click(object sender, EventArgs e)
        {
            if (baseAreaForm == null)
            {
                MessageBox.Show("BaseArea form is not initialized!");
                return;
            }
            baseAreaForm.RefreshSlots();
